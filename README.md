...
![alt text](python-http/output-images/Image_1.png)

2. Git clone.

![alt text](python-http/output-images/Image_2.png)

3. Used “python-http/ (Flask + requests)”.

![alt text](python-http/output-images/Image_3.png)

4. Run both the services A and B.

Service - A - Running:

![alt text](python-http/output-images/Image_4.png)

Service - B - Running:

![alt text](python-http/output-images/Image_5.png)

5. Test Service A health - status is “ok”.

![alt text](python-http/output-images/Image_6.png)

6. Test Service B - echo is “hello” and status is “ok”.

![alt text](python-http/output-images/Image_7.png)

7. Stop service A and keep service B running.

Stopped service A-

![alt text](python-http/output-images/Image_8.png)

Service B is running-

![alt text](python-http/output-images/Image_9.png)

Received HTTP 503 error on the first line in below screenshot.

![alt text](python-http/output-images/Image_10.png)

When run in the browser, you see the JSON error log as shown in below screenshot.

![alt text](python-http/output-images/Image_11.png)
